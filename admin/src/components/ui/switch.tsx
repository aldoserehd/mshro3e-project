...
>(({ className, ...props }, ref) => (
  <SwitchPrimitive.Root
    ...
    className={cn(
      ...
      'data-[state=checked]:bg-navy-900 data-[state=unchecked]:bg-navy-200',
      className,
    )}
    {...props}
  >
    <SwitchPrimitive.Thumb
      className={cn(
        ...
        'data-[state=checked]:translate-x-5 rtl:data-[state=checked]:-translate-x-5 data-[state=unchecked]:translate-x-0.5 rtl:data-[state=unchecked]:-translate-x-0.5',
      )}
    />
  </SwitchPrimitive.Root>
));
